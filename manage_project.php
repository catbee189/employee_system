            ...
            <tbody>
                <?php foreach ($projects as $row): ?>
                    <tr>
                        ...
                        <td>
                            <a href="project_details.php?id=<?= $row['project_id'] ?>" class="btn btn-info btn-sm">Details</a>
                            <a href="edit_project.php?id=<?= $row['project_id'] ?>" class="btn btn-primary btn-sm">Edit</a>
                            <a href="delete_project.php?id=<?= $row['project_id'] ?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
